...
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0:6366F1,100:22D3EE&height=2"/>
...
other_interests: [Filmmaking 🎬, Game Development 🎮]
status: "Currently building Nova — a cross-device personal AI assistant 🚀"
```

- 🔭 Currently working on **Nova**, a personal AI assistant with a hybrid local/cloud LLM architecture
- 🏗️ Building **KoperasiKu**, an Android app for cooperative management (Clean Architecture, MVVM, Supabase, Room)
- 🎮 Developing **Monsverse**, a monster-collecting RPG built with React + Phaser.js
- 🌱 Always learning more about agentic AI tooling and system design
- 💬 Open to collaborating on digital products for Indonesian communities
...
<img src="https://img.shields.io/badge/Phaser-1A237E?style=for-the-badge&logo=phaser&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Room-3E4348?style=for-the-badge&logo=sqlite&logoColor=white"/>
...
### 🐦‍⬛ Nova
A cross-device personal AI assistant with a hybrid local/cloud LLM architecture. Full documentation (PRD, architecture, design) built with the help of the Antigravity AI coding agent.

`AI` `LLM` `Cross-Device` `Architecture`

</td>
<td width="50%">

### 🏪 KoperasiKu
An Android app for managing Indonesian cooperatives, built with Clean Architecture, MVVM, Supabase, and Room.

`Android` `Kotlin` `Clean Architecture` `Supabase`
...
### 👾 Monsverse
A web-based monster-collecting RPG built with React and Phaser.js, with gameplay and hitbox systems still being refined.

`React` `Phaser.js` `Game Dev`

</td>
<td width="50%">

### 🏃 Endless Runner
A web-based endless runner prototype built with Three.js, exploring 3D rendering in the browser.

`Three.js` `WebGL` `Game Dev`
